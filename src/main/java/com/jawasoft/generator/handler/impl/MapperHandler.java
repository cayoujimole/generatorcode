...
public class MapperHandler extends BaseHandler<MapperInfo> {
    ...
    public void combileParams(MapperInfo info) {
        ...
        String pkName = info.getEntityInfo().getPkName();
        String pkType = info.getEntityInfo().getPkType();

        this.param.put("pkName", pkName);
        this.param.put("pkType", pkType);
        this.param.put("pkColumn", pkName);
